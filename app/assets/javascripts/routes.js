...
App.Router.map(function() {
    this.route("biosearch",{
        path: "/biosearch"
    },function(){
        this.route('biosearchReport', {
            path: '/biosearchReport'
        }, function() {
        });
        this.route('biosearchFreeText', {
            path: '/biosearchFreeText'
        }, function() {
        }); 
        this.route('biosearchId', {
            path: '/biosearchId'
        }, function() {
        }); 
        this.route('biosearchHeaderFreeText', {
            path: '/biosearchHeaderFreeText'
        }, function() {
        }); 
        this.route('biosearchHeaderId', {
            path: '/biosearchHeaderId'
        }, function() {
        });         
    });
